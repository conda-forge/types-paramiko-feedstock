...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/types-paramiko-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13197&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/types-paramiko-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `types-paramiko` can be installed with:

```
conda install types-paramiko
```

It is possible to list all of the versions of `types-paramiko` available on your platform with:
